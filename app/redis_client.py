...
class CacheManager:
    ...
    def set(self, prefix: str, identifier: Union[str, int], data: Any, ttl_hours: Optional[int] = None) -> bool:
    ...
    def flush_pattern(self, pattern: str) -> int:
        ...
        try:
            ...
            logger.error("Cache flush pattern error", pattern=pattern, error=str(e))
            return 0
...
class TVDBCache:
    ...
    def set_episode(episode_id: int, data: dict) -> bool:
        """Cache episode data"""
        return cache.set("episode", episode_id, data, settings.cache_ttl_dynamic_hours)
    ...
    def set_movie(movie_id: int, data: dict) -> bool:
        """Cache movie data"""
        return cache.set("movie", movie_id, data, settings.cache_ttl_dynamic_hours)
    ...
    def set_person(person_id: int, data: dict) -> bool:
        """Cache person data"""
        return cache.set("person", person_id, data, settings.cache_ttl_dynamic_hours)
    ...
    def set_static_data(data_type: str, data: dict) -> bool:
        ...
        return cache.set("static", data_type, data, settings.cache_ttl_static_hours)
    ...
    @staticmethod
    def get_search_results(query: str, result_type: str = "series") -> Optional[dict]:
        """Get cached search results"""
        search_key = f"search:{result_type}:{query}"
        return cache.get("search", search_key)
    
    @staticmethod
    def set_search_results(query: str, results: dict, result_type: str = "series") -> bool:
