...
class Movie(BaseModel):
    ...
    artwork = relationship("Artwork", back_populates="movie", cascade="all, delete-orphan")
    characters = relationship("Character", back_populates="movie", cascade="all, delete-orphan")
    
    # Many-to-many relationships
    genres = relationship("Genre", secondary=movie_genres, back_populates="movies")
    companies = relationship("Company", secondary=movie_companies, back_populates="movies")
