...
async def get_person(
    ...
    """
    try:
        logger.info("Person request", person_id=person_id, client=current_client.get("client_name"))
...
async def invalidate_person_cache(
    ...
    try:
        ...
        logger.error("Failed to invalidate person cache", person_id=person_id, error=str(e))
        raise HTTPException(
            status_code=500,
